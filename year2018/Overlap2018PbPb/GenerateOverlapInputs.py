...
for i in range(0,len(UsedL1Seeds)):
    ...
    for j in range(0,70-len(UsedL1Seeds[i])):
        my_new_C_file.write(" ")
...
for i in range(0,len(UsedHLTtriggers)):
    ...
    for j in range(0,70-len(UsedHLTtriggers[i])):
        my_new_C_file.write(" ")
...
for i in range(0,len(L1StringForHlt)):
    ...
    for j in range(0,70-len(L1StringForHlt[i])):
        my_new_C_file.write(" ")
...
myoutputfile1.write("char TrStringsHlt[nTriggersHlt][72] = {\n")
for i in range(0,len(UsedHLTtriggers)):
    myoutputfile1.write("  \"")
...
myoutputfile1.write("char L1StringForHlt[nTriggersHlt][72] = {\n")
for i in range(0,len(L1StringForHlt)):
    myoutputfile1.write("  \"")
...
myoutputfile1.write("const char TrStrings_L1[nTriggers_L1][72] = {\n")
for i in range(0,len(UsedL1Seeds)):
    myoutputfile1.write("  \"")
