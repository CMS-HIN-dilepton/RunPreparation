...
//include Reco_QQ_trig{{{
			...
			theChain->Draw(Form("Reco_QQ_4mom.M()>>massHistoLikeSignBit%d", tBits[itrg]), Form("((HLTriggers&pow(2,%d))==pow(2,%d))&&((Reco_QQ_trig&pow(2,%d))==pow(2,%d))&&Reco_QQ_type==1&&Reco_QQ_sign!=0&&Reco_QQ_mupl_4mom.Pt()>4&&Reco_QQ_mumi_4mom.Pt()>4", tBits[itrg], tBits[itrg], tBits[itrg], tBits[itrg]),"");
...
//without Reco_QQ_trig{{{
			...
			cout << "Drawing mass, like sign... bit " << tBits[itrg] << endl;
			theChain->Draw(Form("Reco_QQ_4mom.M()>>massHistoLikeSignBit%d", tBits[itrg]), Form("((HLTriggers&pow(2,%d))==pow(2,%d))&&Reco_QQ_type==1&&Reco_QQ_sign!=0&&Reco_QQ_mupl_4mom.Pt()>4&&Reco_QQ_mumi_4mom.Pt()>4", tBits[itrg], tBits[itrg]), "");
			cout << "Drawing centrality, bit " << tBits[itrg] << endl;
