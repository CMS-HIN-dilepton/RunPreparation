...
void oniaTree::AllEffCalc(){
  if (treeLabel.find("v18")!=std::string::npos){
  TrigEffCalc("L1DoubleMuOpen");
  TrigEffCalc("L2DoubleMuOpen");
  TrigEffCalc("L3DoubleMuOpen");
  TrigEffCalc("L1DoubleMu0");
  TrigEffCalc("L2DoubleMu0");
  TrigEffCalc("L3DoubleMu0");
  TrigEffCalc("L1DoubleMuOpen_BptxAND");
  TrigEffCalc("L1DoubleMu0_BptxAND");
  TrigEffCalc("L1DoubleMuOpen_OS");
  TrigEffCalc("L1DoubleMuOpen_SS");
  TrigEffCalc("L1DoubleMuOpen_OS_BptxAND");
  TrigEffCalc("L1DoubleMuOpen_SS_BptxAND");
  TrigEffCalc("L1DoubleMuOpen_MAXdR");
  TrigEffCalc("L1DoubleMuOpen_MatchdR");
  }
  else if (treeLabel.find("fulltrk")!=std::string::npos) {
    TrigEffCalc("L1DoubleMuOpen");
    TrigEffCalc("L2DoubleMuOpen");
    TrigEffCalc("L3DoubleMuOpen");
  }
  else if (treeLabel.find("HLTFromEM")!=std::string::npos && treeLabel.find("v16")!=std::string::npos)
    {
      ...
      TrigEffCalc("HLT_HIL1DoubleMu0_MAXdR2p0");
      TrigEffCalc("HLT_HIL1DoubleMu0_MAXdR3p5");
      TrigEffCalc("HLT_HIL1DoubleMu0_OS");
      TrigEffCalc("HLT_HIL1DoubleMu0_OS_MAXdR3p5");
      TrigEffCalc("HLT_HIL1DoubleMu0_SS");
      TrigEffCalc("HLT_HIL1DoubleMu10");
      TrigEffCalc("HLT_HIL2DoubleMuOpen");
      TrigEffCalc("HLT_HIL3DoubleMuOpen");
      TrigEffCalc("HLT_HIL3DoubleMu6");
      TrigEffCalc("HLT_HIL3DoubleMuOpen_psi");
      ...
      TrigEffCalc("HLT_HIL3Mu0_L2Mu0_psi");
      TrigEffCalc("HLT_HIL3Mu0_L2Mu0_Jpsi");
      TrigEffCalc("HLT_HIL3Mu0_L2Mu0_Upsi");
      TrigEffCalc("HLT_HIL3DoubleMuOpenOpen");
      TrigEffCalc("HLT_HIL3DoubleMuOpen6");
      TrigEffCalc("HLT_HIL3DoubleMuOpenOpen_psi");
      TrigEffCalc("HLT_HIL3DoubleMuOpenOpen_Jpsi");
      TrigEffCalc("HLT_HIL3DoubleMuOpenOpen_Upsi");
    }
  else if (treeLabel.find("v26")!=std::string::npos) 
    {
      TrigEffCalc("HLT_HIL1DoubleMuOpen");
      TrigEffCalc("HLT_HIL1DoubleMuOpen_MAXdR2p0");
      TrigEffCalc("HLT_HIL1DoubleMuOpen_OS_MAXdR2p0");
      ...
      TrigEffCalc("HLT_HIL1DoubleMu0_MAXdR3p5");
      TrigEffCalc("HLT_HIL1DoubleMu0_OS");
      TrigEffCalc("HLT_HIL1DoubleMu0_OS_MAXdR2p0");
      TrigEffCalc("HLT_HIL1DoubleMu0_OS_MAXdR3p5");
      TrigEffCalc("HLT_HIL1DoubleMu0_SS");
      TrigEffCalc("HLT_HIL1DoubleMu10");
      ...
      TrigEffCalc("HLT_HIL2DoubleMuOpen");
      TrigEffCalc("HLT_HIL3DoubleMuOpen");
      TrigEffCalc("HLT_HIL3DoubleMuOpen_M60102");
      TrigEffCalc("HLT_HIL3Mu0_L2Mu0");
      TrigEffCalc("HLT_HIL3Mu2p5_L1DoubleMu0");
      TrigEffCalc("HLT_HIL3Mu2p5_L1DoubleMu0_OS");
  ...
  else if (treeLabel.find("v17x2")!=std::string::npos)
    {
      TrigEffCalc("HLT_HIL1DoubleMuOpen");
      TrigEffCalc("HLT_HIL1DoubleMuOpen_Centrality_30_100");
      TrigEffCalc("HLT_HIL1DoubleaMuOpen_Centrality_40_100");
  ...
  else if (treeLabel.find("v20")!=std::string::npos)
    {
      TrigEffCalc("HLT_HIL1DoubleMuOpen");
      TrigEffCalc("HLT_HIL1DoubleMuOpen_Centrality_30_100");
      ...
      TrigEffCalc("HLT_HIL3DoubleMuOpen_Upsi");
      TrigEffCalc("HLT_HIL3Mu0_L2Mu0");
      TrigEffCalc("HLT_HIL3Mu0NHitQ10_L2Mu0");
      TrigEffCalc("HLT_HIL3Mu0_L2Mu0_testignore");
      TrigEffCalc("HLT_HIL3Mu2_L2Mu0");
      TrigEffCalc("HLT_HIL3Mu2p5_L2Mu0");
  ...
  else if (treeLabel.find("v28")!=std::string::npos){
    TrigEffCalc("HLT_HIL1DoubleMuOpen");
    TrigEffCalc("HLT_HIL1DoubleMuOpen_Centrality_30_100");
    TrigEffCalc("HLT_HIL1DoubleMuOpen_Centrality_40_100");
    TrigEffCalc("HLT_HIL1DoubleMuOpen_Centrality_50_100");
  ...
  else if (treeLabel.find("v27")!=std::string::npos){
    TrigEffCalc("HLT_HIL1DoubleMuOpen");
    TrigEffCalc("HLT_HIL1DoubleMuOpen_Centrality_30_100");
    TrigEffCalc("HLT_HIL1DoubleMuOpen_Centrality_40_100");
    TrigEffCalc("HLT_HIL1DoubleMuOpen_Centrality_50_100");
  ...
  else if (treeLabel.find("v30")!=std::string::npos){
    TrigEffCalc("HLT_HIL1DoubleMuOpen");
    TrigEffCalc("HLT_HIL1DoubleMuOpen_Centrality_30_100");
  ...
  else if (treeLabel.find("v33")!=std::string::npos){
    TrigEffCalc("HLT_HIL1DoubleMuOpen"); 
    TrigEffCalc("HLT_HIL1DoubleMuOpen_Centrality_30_100");
    TrigEffCalc("HLT_HIL1DoubleMuOpen_OS_Centrality_30_100");
    TrigEffCalc("HLT_HIL1DoubleMuOpen_Centrality_40_100");
    ...
    TrigEffCalc("L2DoubleMuOpen");
    TrigEffCalc("L3DoubleMuOpen");
    TrigEffCalc("L3DoubleMuOpen_MAXdR");
    TrigEffCalc("L3DoubleMuOpen_MatchdR");
  }
}
...
string trig_v18 [] = 
  {
    ...
    "L2DoubleMu0",
    "L3DoubleMu0",
    "L1DoubleMuOpen_BptxAND",
    "L1DoubleMu0_BptxAND",
    "L1DoubleMuOpen_OS",
    "L1DoubleMuOpen_SS",
    "L1DoubleMuOpen_OS_BptxAND",
    "L1DoubleMuOpen_SS_BptxAND",
    "L3DoubleMuOpen_MAXdR",
    "L3DoubleMuOpen_MatchdR"
  };
...
string trig_EMv16 []=
  {
    ...
    "HLT_HIL1DoubleMu0",
    "HLT_HIL1DoubleMu0_MAXdR2p0",
    "HLT_HIL1DoubleMu0_MAXdR3p5",
    "HLT_HIL1DoubleMu0_OS",
    "HLT_HIL1DoubleMu0_OS_MAXdR3p5",
    "HLT_HIL1DoubleMu0_SS",
    "HLT_HIL1DoubleMu10",
    "HLT_HIL2DoubleMuOpen",
    "HLT_HIL3DoubleMuOpen",
    "HLT_HIL3DoubleMu6",
    "HLT_HIL3DoubleMuOpen_psi",
    "HLT_HIL3DoubleMuOpen_Jpsi",
    "HLT_HIL3DoubleMuOpen_Upsi",
    "HLT_HIL3DoubleMuOpen_M60120",
    "HLT_HIL3Mu0_L2Mu0",
    "HLT_HIL3Mu0_L2Mu0_psi",
    "HLT_HIL3Mu0_L2Mu0_Jpsi",
    "HLT_HIL3Mu0_L2Mu0_Upsi",
    "HLT_HIL3DoubleMuOpenOpen",
    "HLT_HIL3DoubleMuOpen6",
    "HLT_HIL3DoubleMuOpenOpen_psi",
    "HLT_HIL3DoubleMuOpenOpen_Jpsi",
    "HLT_HIL3DoubleMuOpenOpen_Upsi",
  };
string trig_v26 [] =
  {
    "HLT_HIL1DoubleMuOpen",
    ...
    "HLT_HIL2DoubleMuOpen",
    "HLT_HIL3DoubleMuOpen",
    "HLT_HIL3DoubleMuOpen_M60102",
    "HLT_HIL3Mu0_L2Mu0",
    "HLT_HIL3Mu2p5_L1DoubleMu0",
    "HLT_HIL3Mu2p5_L1DoubleMu0_OS",
...
string trig_v30 [] =
 ...
 if (treeLabel.find("v18")!=std::string::npos){
   int nTrig = sizeof(trig_v18)/sizeof(trig_v18[0]);
   for (int i=0; i<nTrig; i++)
     if (trigLabel.find(trig_v18[i])!=std::string::npos && trig_v18[i].find(trigLabel)!=std::string::npos) {
       triggerIndex_PP = i;
     } 
 }
 else if (treeLabel.find("fulltrk")!=std::string::npos) {
 ...
 else if (treeLabel.find("HLTFromEM")!=std::string::npos) {
   int nTrig = sizeof(trig_EMv16)/sizeof(trig_EMv16[0]);
   for (int i=0; i<nTrig; i++)
     if (trigLabel.find(trig_EMv16[i])!=std::string::npos && trig_EMv16[i].find(trigLabel)!=std::string::npos) {
       triggerIndex_PP = i;
     }
 }
 else if (treeLabel.find("v26")!=std::string::npos) {
   int nTrig = sizeof(trig_v26)/sizeof(trig_v26[0]);
   for (int i=0; i<nTrig; i++)
     if (trigLabel.find(trig_v26[i])!=std::string::npos && trig_v26[i].find(trigLabel)!=std::string::npos) {
       triggerIndex_PP = i;
     }
 }
 else if (treeLabel.find("vX")!=std::string::npos) {
   triggerIndex_PP = 0;
 }
 else if (treeLabel.find("v17x2")!=std::string::npos) {
   int nTrig = sizeof(trig_v17x2)/sizeof(trig_v17x2[0]);
   for (int i=0; i<nTrig; i++)
     if (trigLabel.find(trig_v17x2[i])!=std::string::npos && trig_v17x2[i].find(trigLabel)!=std::string::npos) {
       triggerIndex_PP = i;
     }
 }
 else if (treeLabel.find("v20")!=std::string::npos) {
   int nTrig = sizeof(trig_v20)/sizeof(trig_v20[0]);
   for (int i=0; i<nTrig; i++)
     if (trigLabel.find(trig_v20[i])!=std::string::npos && trig_v20[i].find(trigLabel)!=std::string::npos) {
       triggerIndex_PP = i;
     }
 }
 else if (treeLabel.find("v28")!=std::string::npos) {
   int nTrig = sizeof(trig_v28)/sizeof(trig_v28[0]);
   for (int i=0; i<nTrig; i++)
     if (trigLabel.find(trig_v28[i])!=std::string::npos && trig_v28[i].find(trigLabel)!=std::string::npos) {
       triggerIndex_PP = i;
     }
 }
 else if (treeLabel.find("v27")!=std::string::npos) {
   int nTrig = sizeof(trig_v27)/sizeof(trig_v27[0]);
   for (int i=0; i<nTrig; i++)
     if (trigLabel.find(trig_v27[i])!=std::string::npos && trig_v27[i].find(trigLabel)!=std::string::npos) {
       triggerIndex_PP = i;
     }
 }
 else if (treeLabel.find("v30")!=std::string::npos) {
   int nTrig = sizeof(trig_v30)/sizeof(trig_v30[0]);
   for (int i=0; i<nTrig; i++)
     if (trigLabel.find(trig_v30[i])!=std::string::npos && trig_v30[i].find(trigLabel)!=std::string::npos) {
       triggerIndex_PP = i;
     }
 }
 else if (treeLabel.find("v33")!=std::string::npos) {
