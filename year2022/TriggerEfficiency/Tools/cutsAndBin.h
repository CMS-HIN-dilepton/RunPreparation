...
int kTrigL1DBOpen = 0;
int kTrigL1DBZero = 3;
TString fTrigName[Ntrig] = {"Jpsi", "Ups", "L1DoubleMuOpen", "L1DoubleMu0"};
...
// lumi Unc 
double lumi_pp = 300233234.081578553;
double lumi_unc_pp = 0.023;
double nMB_unc = TMath::Sqrt(0.02*0.02+0.01*0.01);

struct ParticleName { string JPsi, Psi2S, Y1S, Y2S, Y3S, Z, PiPlus, KaPlus, D0, Dpm, B0, Bpm;};
ParticleName pdgName = {"Jpsi", "Psi2S", "Y1S", "Y2S", "Y3S", "Z", "PiPlus", "KaPlus", "D0", "Dpm", "B0", "Bpm"};
string pdgNameStr[12] = {"Jpsi", "Psi2S", "Y1S", "Y2S", "Y3S", "Z", "PiPlus", "KaPlus", "D0", "Dpm", "B0", "Bpm"};

struct ParticleMass { double JPsi, Psi2S, Y1S, Y2S, Y3S, Z, PiPlus, KaPlus, D0, Dpm, B0, Bpm;};
ParticleMass pdgMass = {3.096, 3.686, 9.460, 10.023, 10.355, 91.188, 0.139570, 0.49367, 1.86483, 1.86965, 5.27964, 5.27933};

const int nPtBins1S = 7;
const int nPtBins2S_16023 = 3;
const int nPtBins2S = 5;
const int nPtBins3S = 4;
double ptbin1S[nPtBins1S+1] = {0,2,4,6,9,12,15,30};
double ptbin2S_16023[nPtBins2S+1] = {0,4,9,30};
double ptbin2S[nPtBins2S+1] = {0,3,6,9,15,30};
double ptbin3S[nPtBins3S+1] = {0,4,9,15,30};
...
TString getKineLabel(float ptLow, float ptHigh, float yLow, float yHigh, float muPtCut_) {
